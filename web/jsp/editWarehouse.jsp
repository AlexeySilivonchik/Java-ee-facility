...
<html>
    ...
    <div id="main">
        ...
        <div id="addProductCenter">
            <br>
            <form action="MainServlet?command=editWarehouse&v=2" method="post">
                ...
                <table class="addProd">
                    ...
                    <tr>
                        <td class="addProd">Введите категорию склада:</td>
                        <td class="addProd">
                            <input type="text"
                                   maxlength="4"
                                   size="40"
                                   value="${warehouse.category}"
                                   name="category"
                                   style="margin:5px">
                        </td>
                    </tr>
                    <tr>
                        <td class="addProd">Введите площадь склада:</td>
                        <td class="addProd">
                            <input type="text"
                                   maxlength="10"
                                   size="40"
