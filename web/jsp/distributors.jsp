...
<html>
    ...
    <div id="main">
        ...
        <div id="productionCenter">
            <br><h3 align="center">Дистрибьюторы</h3>
            <c:forEach var="distributor" items="${distributors}">
                <h2><span style="font:bold italic 20px/25px Georgia; float: left">&nbsp;&nbsp;<c:out value="${distributor.name}"/></span></h2>
                <br>
                <span style="float: right; margin-right: 50px">
                    <a href="MainServlet?command=deleteDistributor&id=${distributor.id}" class="line" style="color: #31a900; font-size: 14px;">Удалить</a>
                    <a href="MainServlet?command=editDistributor&id=${distributor.id}&v=1"class="line" style="color: #31a900; font-size: 14px;">Редактировать</a>
                </span>
                <br>
                <c:out value="Адрес дистрибьютора: ${distributor.address}."/>       
                <hr style="width: 500px">
            </c:forEach>

                <br>
            <form action="MainServlet?command=addDistributor&v=1" method="post">
                <input type="submit"
                       name="submit"
                       value="Добавить">
            </form>
