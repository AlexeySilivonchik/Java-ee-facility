...
<html>
    <head>
        ...
        <title>Поиск дистрибьютеров</title>
    ...
    <div id="main">
        ...
        <div id="addProductCenter">
            <br>
            <form action="MainServlet?command=search&v=5" method="post">
                <table class="addProd">
                    <tr>
            ...
            <table>
                ...
                <tr>
                    <td><c:out value="Адрес дистрибьютора:    "/></td>
                    <td><c:out value="${distributor.address}"/></td>
                </tr>
            </table>
