...
<html>
    <head>
        ...
        <title>Изменить продукцию</title>
    ...
    <div id="main">
        ...
        <div id="addProductCenter">
            <br>
            <form action="MainServlet?command=editProduct&v=2" method="post">
                <table class="addProd">
                    <tr>
